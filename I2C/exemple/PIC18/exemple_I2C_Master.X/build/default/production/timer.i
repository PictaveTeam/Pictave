...
# 165 "timer.c"
    ...
    prescaler(period, &prUsed, 128U, &prescUsed, &min);
    prescaler(period, &prUsed, 64U, &prescUsed, &min);
    prescaler(period, &prUsed, 32U, &prescUsed, &min);
    prescaler(period, &prUsed, 16U, &prescUsed, &min);
    prescaler(period, &prUsed, 8U, &prescUsed, &min);
    prescaler(period, &prUsed, 4U, &prescUsed, &min);
    prescaler(period, &prUsed, 2U, &prescUsed, &min);
    switch(prescUsed)
    {
        case 256U:
